...
describe('Testing auth actions', () => { 
    ...
    test('startLogin do login', async() => {
        await store.dispatch(startLogin(testCredentials.email, testCredentials.password))
        ...
        expect(localStorage.setItem).toHaveBeenCalledWith('token-created', expect.any(Number))
