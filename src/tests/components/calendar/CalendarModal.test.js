...
describe('Testing Calendar Modal', () => { 
    ...
    test('should render modal', () => { 
     ...
     test('should call open and close modal', () => { 
         ...
         expect(eventStartUpdateCurrent).toHaveBeenCalledWith(initState.calendar.current)
       ...
       test('should validate dates', () => {
           ...
           wrapper.find('form').simulate('submit', {
            ...
            expect(Swal.fire).toHaveBeenCalledWith("Error", "Date end should be major than start")
       })
 })